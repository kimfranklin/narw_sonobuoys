...
plt
ggsave(plt, filename = paste0('figures/call_rate_category_2019.png'), 
...
png(paste0(fig_dir, 'calls_rates_all_2019.png'), height = 12, width = 7,
    units = 'in', res = 300)
...
pltd
ggsave(pltd, filename = paste0('figures/demogrpahics_category_2019.png'), 
       height = 5, width = 8, units = 'in', dpi = 300)
...
dfp = df %>%
  select("yday", "foraging", "social_notsag", "social_sag", "other_bhv",
  "mom_calf","entg_eff") %>%
  mutate(date = as.Date(yday, origin = '2018-01-01')) %>% 
  gather(key = "behaviour" , value = "cval", foraging, social_notsag, social_sag, other_bhv,
         mom_calf,entg_eff)
...
pltb
ggsave(pltb, filename = paste0('figures/behaviour_category_2019.png'), 
       height = 5, width = 8, units = 'in', dpi = 300)
...
png(paste0(fig_dir, 'vsual_all_2019.png'), height = 10, width = 8,
    units = 'in', res = 300)
...
png(paste0(fig_dir, 'bheaviours_regressions_2019.png'), height = 8, width = 6,
    units = 'in', res = 300)
